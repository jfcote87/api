...
// Usage example:
//
//   import "github.com/jfcote87/api/fusiontables/v1"
//   ...
...
var baseURL *url.URL = &url.URL{Scheme: "https", Host: "www.googleapis.com", Path: "/fusiontables/v1/"}
...
func (c *TableImportRowsCall) Upload(ctx context.Context, u googleapi.UploadCaller) *TableImportRowsCall {
	...
	case *googleapi.MediaUpload:
		c.pathTemplate_ = "/upload/fusiontables/v1/tables/{tableId}/import"
	case *googleapi.ResumableUpload:
		c.pathTemplate_ = "/resumable/upload/fusiontables/v1/tables/{tableId}/import"
	}
	return c
}
...
func (c *TableImportTableCall) Upload(ctx context.Context, u googleapi.UploadCaller) *TableImportTableCall {
	...
	switch u.(type) {
	case *googleapi.MediaUpload:
		c.pathTemplate_ = "/upload/fusiontables/v1/tables/import"
	case *googleapi.ResumableUpload:
		c.pathTemplate_ = "/resumable/upload/fusiontables/v1/tables/import"
	}
	return c
}
